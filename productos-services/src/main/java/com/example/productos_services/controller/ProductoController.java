...
public class ProductoController {
    ...
    public ResponseEntity<?> crearProducto(@RequestBody Map<String, Object> body) {
        ...
        if (!(dataObj instanceof Map)) {
            return ResponseEntity.badRequest().body(Map.of("errors", List.of(Map.of("detail", "Formato de datos inválido"))));
        }
        @SuppressWarnings("unchecked")
        Map<String, Object> data = (Map<String, Object>) dataObj;
        Object attributesObj = data.get("attributes");
        if (!(attributesObj instanceof Map)) {
            return ResponseEntity.badRequest().body(Map.of("errors", List.of(Map.of("detail", "Formato de atributos inválido"))));
        }
        @SuppressWarnings("unchecked")
